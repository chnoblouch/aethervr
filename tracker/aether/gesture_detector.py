from aether.tracking_state import TrackingState, HandState
from aether.input_state import InputState, ControllerState, ControllerButton
from aether.config import Config, ControllerConfig, Gesture
import math
...
class GestureDetector:
    ...
    def __init__(
        self, config: Config, tracking_state: TrackingState, input_state: InputState
    ):
        self.config = config
